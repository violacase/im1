...
declare global {
  ...
  const useCandles: typeof import('./src/composables/useCandles')['useCandles']
  const useCandlesApi: typeof import('./src/composables/useSupabase')['useCandlesApi']
  ...
  const useTranslatedRoutes: typeof import('./src/composables/useTranslatedRoutes')['useTranslatedRoutes']
